הנה הקובץ המלא והסופי בפורמט **Markdown** (קובץ `.md`).
הכנסתי פנימה את כל השיפורים האחרונים, כולל התיקון לסעיף הארכיטקטורה והדגשת נושא המזווה והכמויות.

אתה יכול להעתיק את כל הטקסט למטה ופשוט לשמור אותו כ-`README.md`.
